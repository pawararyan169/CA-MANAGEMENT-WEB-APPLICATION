document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!form) {
        ...
        console.error(
            "Admin Add Client: #clientForm not found."
        );
    ...
    if (!stateSelect) {
        ...
        console.error(
            "Admin Add Client: state select not found."
        );
    ...
    if (!districtSelect) {
        ...
        console.error(
            "Admin Add Client: district select not found."
        );
    ...
    if (!citySelect) {
        ...
        console.error(
            "Admin Add Client: city select not found."
        );
    ...
    function initializeLocations() {
        ...
        if (!locationAPI) {
            ...
            showError(
                "Location data could not be loaded. Please refresh the page."
            );
    ...
    form.addEventListener(
        ...
        async event => {
            ...
            /*
             * Every state must have a district.
             */
            ...
            /*
             * Every state must have a city/town.
             */
